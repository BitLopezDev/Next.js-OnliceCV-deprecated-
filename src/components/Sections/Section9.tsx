...
import security from './../../styles/security.module.scss';
...
const Section9 = () => {
    return (
        ...
        <React.Fragment>
            <center> <h2>Estudios independientes en Udemy</h2></center>
            <br />
            ...
            <div className="container mt-3">
                <h4>Preparación para Auditor Líder e Interno ISO/IEC 27001</h4>
                <div className="progress">
                    <div className="progress-bar fondogradiente" style={{ width: "0%" }}>00%</div>
                </div>
                <br />
            ...
            <div className="container mt-3">
                <h4>ISO/IEC 27001: Prepara a las empresas para la certificación</h4>
                <div className="progress">
                    <div className="progress-bar fondogradiente" style={{ width: "0%" }}>00%</div>
                </div>
            </div>
