            ...
            <center>
                ...
                <div className="card w-60" style={{ width: '100%', backgroundColor: 'white !important' }}>
                    <div className="card-img-top d-flex align-items-center">
                        ...
                        <p className="card-text"><strong>React</strong> Estando familiarizado con tecnologías tales como React.js, Bootstrap y jQuery, puedo incorporarme fácilmente a la gran mayoría de proyectos de desarrollo web. </p>
                    </div>
